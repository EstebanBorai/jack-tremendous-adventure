use bevy::{
  prelude::{
      App, AssetServer, Assets, Bundle, FromWorld, Handle, Mut, Plugin, Query, Res, Resource,
      Update, Vec2, With, error,
  },
...
impl PlayerAnimationPlugin {
  ...
  fn animate_player(
      ...
      let (player, mut atlas, mut animation, mut sprite, jump) = player.single_mut();
